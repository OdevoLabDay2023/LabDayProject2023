...
public class CreateWorkOrderHandlerFoo2 : ICommandHandler<CreateWorkOrderCommand, WorkOrderEntity>
{
    private readonly WorkOrderDbContext dbContext;

    public CreateWorkOrderHandlerFoo2(WorkOrderDbContext dbContext)
    {
